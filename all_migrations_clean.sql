...
ALTER TABLE "api_logs" ADD CONSTRAINT "api_logs_channel_id_whatsapp_channels_id_fk" FOREIGN KEY ("channel_id") REFERENCES "public"."whatsapp_channels"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "automation_execution_logs" ADD CONSTRAINT "automation_execution_logs_execution_id_automation_executions_id_fk" FOREIGN KEY ("execution_id") REFERENCES "public"."automation_executions"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "automation_executions" ADD CONSTRAINT "automation_executions_automation_id_automations_id_fk" FOREIGN KEY ("automation_id") REFERENCES "public"."automations"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "automation_executions" ADD CONSTRAINT "automation_executions_contact_id_contacts_id_fk" FOREIGN KEY ("contact_id") REFERENCES "public"."contacts"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "automation_executions" ADD CONSTRAINT "automation_executions_conversation_id_conversations_id_fk" FOREIGN KEY ("conversation_id") REFERENCES "public"."conversations"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "automation_nodes" ADD CONSTRAINT "automation_nodes_automation_id_automations_id_fk" FOREIGN KEY ("automation_id") REFERENCES "public"."automations"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "automations" ADD CONSTRAINT "automations_channel_id_channels_id_fk" FOREIGN KEY ("channel_id") REFERENCES "public"."channels"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "campaigns" ADD CONSTRAINT "campaigns_channel_id_channels_id_fk" FOREIGN KEY ("channel_id") REFERENCES "public"."channels"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "contacts" ADD CONSTRAINT "contacts_channel_id_channels_id_fk" FOREIGN KEY ("channel_id") REFERENCES "public"."channels"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "conversation_assignments" ADD CONSTRAINT "conversation_assignments_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "message_queue" ADD CONSTRAINT "message_queue_campaign_id_campaigns_id_fk" FOREIGN KEY ("campaign_id") REFERENCES "public"."campaigns"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "message_queue" ADD CONSTRAINT "message_queue_channel_id_whatsapp_channels_id_fk" FOREIGN KEY ("channel_id") REFERENCES "public"."whatsapp_channels"("id") ON DELETE no action ON UPDATE no action;
...
CREATE INDEX "automation_executions_status_idx" ON "automation_executions" USING btree ("status");
CREATE INDEX "automation_nodes_automation_idx" ON "automation_nodes" USING btree ("automation_id");
CREATE INDEX "automations_channel_idx" ON "automations" USING btree ("channel_id");
CREATE INDEX "automations_status_idx" ON "automations" USING btree ("status");
CREATE INDEX "recipients_campaign_idx" ON "campaign_recipients" USING btree ("campaign_id");
CREATE INDEX "recipients_status_idx" ON "campaign_recipients" USING btree ("status");
CREATE INDEX "recipients_phone_idx" ON "campaign_recipients" USING btree ("phone");
CREATE INDEX "campaigns_channel_idx" ON "campaigns" USING btree ("channel_id");
CREATE INDEX "campaigns_status_idx" ON "campaigns" USING btree ("status");
CREATE INDEX "campaigns_created_idx" ON "campaigns" USING btree ("created_at");
CREATE INDEX "contacts_channel_idx" ON "contacts" USING btree ("channel_id");
...
CREATE INDEX "conversations_channel_idx" ON "conversations" USING btree ("channel_id");
CREATE INDEX "conversations_contact_idx" ON "conversations" USING btree ("contact_id");
CREATE INDEX "conversations_phone_idx" ON "conversations" USING btree ("contact_phone");
...
CREATE INDEX "messages_whatsapp_idx" ON "messages" USING btree ("whatsapp_message_id");
...
ALTER TABLE "automation_nodes" ADD COLUMN "measured" jsonb DEFAULT '{}'::jsonb;
ALTER TABLE "automation_edges" ADD CONSTRAINT "automation_edges_automation_id_automations_id_fk" FOREIGN KEY ("automation_id") REFERENCES "public"."automations"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "automation_edges" ADD CONSTRAINT "automation_edges_source_node_id_automation_nodes_node_id_fk" FOREIGN KEY ("source_node_id") REFERENCES "public"."automation_nodes"("node_id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "automation_edges" ADD CONSTRAINT "automation_edges_target_node_id_automation_nodes_node_id_fk" FOREIGN KEY ("target_node_id") REFERENCES "public"."automation_nodes"("node_id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "messages" ADD COLUMN "media_id" varchar;
...
ALTER TABLE "conversations" ADD COLUMN "chatbot_id" integer;
ALTER TABLE "conversations" ADD COLUMN "session_id" text;
ALTER TABLE "messages" ADD COLUMN "from_type" varchar DEFAULT 'user';
...
ALTER TABLE "contacts" ADD COLUMN "tenant_id" varchar;
CREATE INDEX "articles_category_idx" ON "knowledge_articles" USING btree ("category_id");
CREATE INDEX "articles_published_idx" ON "knowledge_articles" USING btree ("published");
CREATE INDEX "categories_site_idx" ON "knowledge_categories" USING btree ("site_id");
...
CREATE TYPE "public"."user_type" AS ENUM('user', 'team', 'admin');
...
ALTER TABLE "contacts" ADD COLUMN "created_by" varchar DEFAULT '';
ALTER TABLE "sent_notifications" ADD CONSTRAINT "sent_notifications_notification_id_notifications_id_fk" FOREIGN KEY ("notification_id") REFERENCES "public"."notifications"("id") ON DELETE no action ON UPDATE no action;
...
ALTER TABLE "campaigns" ADD COLUMN "created_by" varchar;
ALTER TABLE "templates" ADD COLUMN "created_by" varchar;
ALTER TABLE "firebase_config" ADD COLUMN "private_key" text;
ALTER TABLE "firebase_config" ADD COLUMN "client_email" text;
ALTER TABLE "firebase_config" ADD COLUMN "vapid_key" text;
...
ALTER TABLE "notifications" ALTER COLUMN "target_type" SET DATA TYPE varchar;
ALTER TABLE "notifications" ALTER COLUMN "status" SET DATA TYPE varchar;
ALTER TABLE "notifications" ALTER COLUMN "status" SET DEFAULT 'draft';
ALTER TABLE "sent_notifications" ALTER COLUMN "id" SET DATA TYPE serial;
ALTER TABLE "sent_notifications" ALTER COLUMN "id" DROP DEFAULT;
ALTER TABLE "sent_notifications" ALTER COLUMN "notification_id" SET DATA TYPE integer;
ALTER TABLE "sent_notifications" ALTER COLUMN "user_id" SET DATA TYPE uuid;
ALTER TABLE "notifications" ADD COLUMN "type" varchar DEFAULT 'general' NOT NULL;
ALTER TABLE "notifications" ADD COLUMN "created_by" varchar DEFAULT 'system' NOT NULL;
ALTER TABLE "sent_notifications" ADD CONSTRAINT "sent_notifications_notification_id_notifications_id_fk" FOREIGN KEY ("notification_id") REFERENCES "public"."notifications"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "sites" ADD COLUMN "channel_id" varchar;
...
ALTER TABLE "panel_config" ADD COLUMN "currency" varchar(10) DEFAULT 'INR';
...
ALTER TABLE "ai_settings" ADD COLUMN "channel_id" varchar;
